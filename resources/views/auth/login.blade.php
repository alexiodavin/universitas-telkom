...
<body>
            ...
            <div class="card shadow" style="border-radius: 10px;">
                ...
                <div class="card-body login-card-body" style="border-radius: 10px;">
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="row">                        
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary btn-block shadow mb-3">Login</button>
                                <center>
                                    <a style="color: red;" href="{{ route('frontend.forgot-password') }}">Forgot password ?</a>
                                </center>
                            </div>
                        </div>
                    </form>
    ...
    @if(request()->role == 'Dosen')
        ...
        @endphp
    @elseif(request()->role == 'Koordinator-PA')
        @php
            session(['auth_login' => 'koordinator_pa']);
        @endphp
    @elseif(request()->role == 'Kaprodi')
        @php
            session(['auth_login' => 'kaprodi']);
        @endphp
    @else
        @php
              session(['auth_login' => 'dosen']);
