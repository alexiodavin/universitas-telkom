                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body table-responsive">
                                ...
                                <div class="row">
                                    ...
                                    {{-- <div class="col-4">
                                        <b>Nilai Mutu : 
                                            @if ($item->nilai_penguji1->nilai_akhir >= 80)
                                                A
                                            @elseif($item->nilai_penguji1->nilai_akhir >= 70 && $item->nilai_penguji1->nilai_akhir < 80)
                                                AB
                                            @elseif($item->nilai_penguji1->nilai_akhir >= 65 && $item->nilai_penguji1->nilai_akhir < 70)
                                                B
                                            @elseif($item->nilai_penguji1->nilai_akhir >= 60 && $item->nilai_penguji1->nilai_akhir < 65)
                                                BC
                                            @elseif($item->nilai_penguji1->nilai_akhir >= 50 && $item->nilai_penguji1->nilai_akhir < 60)
                                                C
                                            @elseif($item->nilai_penguji1->nilai_akhir >= 40 && $item->nilai_penguji1->nilai_akhir < 50)
                                                D
                                            @elseif($item->nilai_penguji1->nilai_akhir >= 0 && $item->nilai_penguji1->nilai_akhir < 40)
                                                E
                                            @endif
                                        </b>
                                    </div>
                                    <div class="col-4">
                                         <b>Status : {{ $item->nilai_penguji1->nilai_akhir > 50 ? 'Lulus' : 'Tidak Lulus' }}</b>
                                    </div> --}}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body table-responsive">
                                ...
                                <div class="row">
                                    ...
                                    {{-- <div class="col-4">
                                        <b>Nilai Mutu : 
                                            @if ($item->nilai_penguji2->nilai_akhir >= 80)
                                                A
                                            @elseif($item->nilai_penguji2->nilai_akhir >= 70 && $item->nilai_penguji2->nilai_akhir < 80)
                                                AB
                                            @elseif($item->nilai_penguji2->nilai_akhir >= 65 && $item->nilai_penguji2->nilai_akhir < 70)
                                                B
                                            @elseif($item->nilai_penguji2->nilai_akhir >= 60 && $item->nilai_penguji2->nilai_akhir < 65)
                                                BC
                                            @elseif($item->nilai_penguji2->nilai_akhir >= 50 && $item->nilai_penguji2->nilai_akhir < 60)
                                                C
                                            @elseif($item->nilai_penguji2->nilai_akhir >= 40 && $item->nilai_penguji2->nilai_akhir < 50)
                                                D
                                            @elseif($item->nilai_penguji2->nilai_akhir >= 0 && $item->nilai_penguji2->nilai_akhir < 40)
                                                E
                                            @endif
                                        </b>
                                    </div>
                                    <div class="col-4">
                                         <b>Status : {{ $item->nilai_penguji2->nilai_akhir > 50 ? 'Lulus' : 'Tidak Lulus' }}</b>
                                    </div> --}}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card shadow">
                                ...
                                <div class="card-body table-responsive">
                                    <button class="btn btn-primary" style="width: 100%; cursor: default;">Nilai Akhir {{ $item->nilai_final->nilai_final }}</button>
                                    <br>
                                    <br>
                                    <div class="row">
                                        <div class="col-6">
