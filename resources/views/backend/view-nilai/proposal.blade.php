                          ...
                          <div class="card-header">
                            ...
                            <div class="card-body table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($items as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->proposal->tahun_ajaran }} {{ $item->proposal->semester }}</td>
                                ...
                                @if(session('auth_login') == 'koordinator_pa')
                                    <a href="{{ route('backend.koordinator-pa.view-nilai-proposal.download') }}" class="btn btn-primary shadow bg-primary float-right mt-3">Download</a>
                                @endif
                            </div>
                        </div>
                    </div>
