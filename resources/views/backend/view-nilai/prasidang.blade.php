                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($items as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->prasidang->tahun_ajaran }} {{ $item->prasidang->semester }}</td>
                                ...
                                @if(session('auth_login') == 'koordinator_pa')
                                    <a href="{{ route('backend.koordinator-pa.view-nilai-prasidang.download') }}" class="btn btn-primary shadow bg-primary float-right mt-3">Download</a>
                                @endif
                            </div>
                        </div>
                    </div>
