    ...
    <div class="content-wrapper">
        <div class="content-header ml-4 mr-4">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Edit Daftar Periode</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card shadow">
                            <div class="card-body">
                                <form action="{{ route('backend.admin.periode-semester.update', ['id' => $item->id]) }}"
                                    method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label font-weight-bold">Tahun Ajaran<span
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="semester" class="form-control" required>
                                                <option value="Genap" @if ($item->semester == 'Genap') selected @endif>
                                                    Genap</option>
                                                <option value="Ganjil" @if ($item->semester == 'Ganjil') selected @endif>
                                                    Ganjil</option>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label font-weight-bold">Tahun <span
                                                style="color:red;"> *</span></label>
                                        <div class="col-sm-10">
