    ...
    <div class="content-wrapper">
        <div class="content-header ml-4 mr-4">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Input Daftar Nilai Mutu</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card shadow">
                            <div class="card-body">
                                <form action="{{ route('backend.admin.nilai-mutu.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    <div class="form-group row">
                                    <label class="col-sm-2 col-form-label font-weight-bold">Kode Mutu <span style="color:red;"> *</span></label>
                                        <div class="col-sm-10">
                                            <input type="text" name="index" class="form-control" value="{{ old('index') }}" required>
                                            @if ($errors->has('index'))
                                    ...
                                    <label class="col-sm-2 col-form-label font-weight-bold">Nilai Min <span style="color:red;"> *</span></label>
                                        <div class="col-sm-10">
                                            <input type="number" name="nilai_min" class="form-control" value="{{ old('nilai_min') }}" required>
                                    ...
                                    <label class="col-sm-2 col-form-label font-weight-bold">Nilai Maks <span style="color:red;"> *</span></label>
                                        <div class="col-sm-10">
                                            <input type="number" name="nilai_maks" class="form-control" value="{{ old('nilai_maks') }}" required>
