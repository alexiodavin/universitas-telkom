    ...
    <div class="content-wrapper">
        <div class="content-header ml-4 mr-4">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Edit Daftar Kaprodi</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card shadow">
                            <div class="card-body">
                                <form action="{{ route('backend.admin.dosen-kaprodi.update', ['id' => $item->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label font-weight-bold">Dosen Kaprodi <span style="color:red;"> *</span></label>
                                        <div class="col-sm-10">
                                            <select id="dosen_id" name="dosen_id" class="form-control" required>
                                                <option value="">Pilih Dosen Kaprodi</option>
                                                @foreach ($dosens as $dosen)
                                                    <option value="{{ $dosen->id }}" @if($dosen->id == $item->dosen_id) selected @endif>{{ $dosen->nama_gelar }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label font-weight-bold">Kode Dosen <span style="color:red;"> *</span></label>
                                        <div class="col-sm-10">
                                            <input type="text" id="kode" class="form-control" value="{{ $item->dosen->kode }}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label font-weight-bold">NIP Dosen <span style="color:red;"> *</span></label>
                                        <div class="col-sm-10">
                                            <input type="text" id="nip" class="form-control" value="{{ $item->dosen->nip }}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label font-weight-bold">Awal Masa Jabatan <span style="color:red;"> *</span></label>
                                        <div class="col-sm-10">
                                            <input type="date" id="awal_menjabat" name="awal_menjabat" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label font-weight-bold">Akhir Masa Jabatan <span style="color:red;"> *Kosongkan bila masih menjabat</span></label>
                                        <div class="col-sm-10">
                                            <input type="date" id="akhir_menjabat"  name="akhir_menjabat" class="form-control">
                                        </div>
                                    </div>
                                    {{-- <div class="form-group row">
