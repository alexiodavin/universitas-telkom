            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card shadow">
                            <div class="card-body">
                                <form action="{{ route('backend.dosen.nilai-mahasiswa.proposal.update-nilai', ['id' => $item->id]) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <button class="btn btn-primary float-right" onclick="hitungNilai()" type="button" style="margin: 0 25px 0 0">Hitung Nilai</button>
                                    @endif
                                    @if ($item->nilai_penguji1)
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                ...
                                <table class="table table-hover border" style="width: 100%; border: 0; ">
                                    <tbody>
                                        <tr>
                                            <form action="{{ route('backend.dosen.nilai-mahasiswa.proposal.update', ['id' => $item->id]) }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <div class="d-flex flex-row">
                                                                ...
                                                                <div class="font-weight-bold pt-1 mx-3">Masukkan File Kontrak proposal</div>
                                                            </div>
        ...
        <center>
            @if($item->nilai_final == null)
                @if($item->nilai_penguji1 && $item->nilai_penguji2)
                    <a href="{{ route('backend.dosen.nilai-mahasiswa.proposal.set-nilai-akhir', ['id' => $item->id]) }}" class="btn btn-primary">Simpan Nilai Akhir</a>
                    <br><br>
                @endif
            @endif
        </center>
