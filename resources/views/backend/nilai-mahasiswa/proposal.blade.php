    ...
    <div class="content-wrapper">
        <div class="content-header ml-4 mr-4">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Daftar Mahasiswa Proposal</h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12">
                        <div class="card shadow">
                            <div class="card-body table-responsive">
                                <table id="table-proposal" class="table table-hover borderless" style="width: 100%; border: 0;">
                                    <thead>
                                        <tr>
                                        ...
                                        @foreach ($items as $item)
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <a href="{{ route('backend.dosen.nilai-mahasiswa.proposal.edit', ['id' => $item->id]) }}" class="btn btn-primary shadow bg-primary"> <i class="fa fa-edit"></i> Edit</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            var filterWrapper = $('<div class="form-group"></div>').appendTo('#table-proposal_wrapper .dataTables_length');
