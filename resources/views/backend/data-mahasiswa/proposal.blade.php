                    ...
                    <div class="col-12">
                        <div class="card shadow">
                            <div class="card-body table-responsive">
                                <table id="table-proposal-kaprodi" class="table table-hover borderless" style="width: 100%; border: 0;">
                                    <thead>
                                        <tr>
...
@section('js')
    <script>
        $(document).ready(function() {
            var table = $('#table-proposal-kaprodi').DataTable({
                "lengthMenu": [10, 25, 50, 100],
            });
            table.column(8).visible(false);
            var filterWrapper = $('<div class="form-group"></div>').appendTo('#table-proposal-kaprodi_wrapper .dataTables_length');
