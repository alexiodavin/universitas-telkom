    ...
    <div class="content-wrapper">
        <div class="content-header ml-4 mr-4">
            <div class="container-fluid">
                <h1 class="m-0 text-dark">Input Komponen Nilai Proposal (Tahap 1)</h1>
            </div>
        </div>
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <center>
                                                    ...
                                                    @if ($total_komponen_proposal < 100)
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Komponen Nilai Proposal (Tahap 1)</h5>
