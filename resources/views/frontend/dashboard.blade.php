...
<body>
    <div class="container" style="margin-top: 150px;">
        <center>
            ...
            <br>
            <a href="{{ route('login') }}" class="btn btn-primary mb-3" style="width: 100%; max-width: 300px;"><h1>Mahasiswa</h1></a>
            <br>
            <a href="{{ route('login') }}" class="btn btn-primary mb-3" style="width: 100%; max-width: 300px;"><h1>Kaprodi</h1></a>
        </center>
    </div>
    <br>
    <br>
