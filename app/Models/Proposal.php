...
class Proposal extends Model
{
    ...
    {
        return $this->hasOne('App\Models\NilaiProposalFinal', 'proposal_id')->withTrashed();
    }
    ...
    {
        return NilaiProposal::whereProposalId($this->attributes['id'])->wherePenguji(1)->first();
    }

    public function getNilaiPenguji2Attribute()
    {
        return NilaiProposal::whereProposalId($this->attributes['id'])->wherePenguji(2)->first();
    }
}
